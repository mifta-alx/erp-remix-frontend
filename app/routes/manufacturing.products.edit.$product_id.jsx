...
//   return { categories, product, API_URL:apiEndpoint, STORAGE_URL:storageEndpoint };
// };
...
//       if (errorData.errors) {
//         return json(
//           { errors: errorData.errors, values },
...
//       );
//     }
//     return redirect("/manufacturing/products");
//   } catch (error) {
//     return json({ error: "Internal Server Error", values }, { status: 500 });
//   }
// };
...
//   const imageUrl = `${STORAGE_URL}/${product.image}`
...
//     } else {
//       const errorData = await response.json();
//       console.error("Gagal menghapus item:", errorData);
//     }
//   };
...
//             action={`manufacturing/products/edit/${product.id}`}
//           >
...
//                     defaultValue={
//                       actionData?.values?.product_name ||
//                       product.name ||
//                       ""
//                     }
//                   />
...
//                     placeholder="Rp. 0"
//                     defaultValue={
//                       actionData?.values?.cost || product.cost || 0
//                     }
//                   />
//                   {actionData?.errors?.cost && (
...
//                     placeholder="PRO-001"
//                     defaultValue={
//                       actionData?.values?.barcode || product.barcode || ""
//                     }
//                   />
//                   {actionData?.errors?.barcode && (
//                     <p className="mt-2 text-sm text-red-600">
...
//                     placeholder="PRO-001"
//                     defaultValue={
//                       actionData?.values?.internal_reference ||
...
//                     defaultValue={
//                       actionData?.values?.notes || product.notes || ""
//                     }
//                   ></textarea>
//                 </div>
//               </div>
